...
public class FragCompleted extends Fragment implements IView {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new StringAdapter(getActivity(),9);
    ...
    private void loadData() {
        persenter.sendGet(Constant.QUANBU + "?status=9&page=1&count=5", OrderBean.class);
