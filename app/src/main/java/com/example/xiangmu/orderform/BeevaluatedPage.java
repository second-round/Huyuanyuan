...
public class BeevaluatedPage extends Fragment implements IView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_beevaluated, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new StringAdapter(getActivity(),3);
    ...
    private void loadData() {
        persenter.sendGet(Constant.QUANBU + "?status=3&page=1&count=5", OrderBean.class);
