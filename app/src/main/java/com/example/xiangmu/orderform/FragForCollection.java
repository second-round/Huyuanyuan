...
public class FragForCollection extends Fragment implements IView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_forvollection, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setShopCarListener(new StringAdapter.ShopCarListener() {
            ...
            public void callBack(OrderBean.OrderListBean list) {
                ...
                persenter.onPutStartRequest(Constant.SHOUHUO,map,RegBean.class);
            }
        });
    }
    ...
    private void loadData() {
        persenter.sendGet(Constant.QUANBU + "?status=2&page=1&count=5", OrderBean.class);
    }
}
