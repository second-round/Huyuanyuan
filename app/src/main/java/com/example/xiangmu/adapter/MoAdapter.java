...
public class MoAdapter extends RecyclerView.Adapter<MoAdapter.ViewHolder> {
    ...
    public void setData(List<HomeBean.ResultBean.MlssBean.CommodityListBeanXX> datas) {
        list.clear();
        if (datas!=null){
            list.addAll(datas);
        }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(context).inflate(R.layout.item_mo,viewGroup,false);
